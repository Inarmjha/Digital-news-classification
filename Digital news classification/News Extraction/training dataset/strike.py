...
states=['Andhra Pradesh','Karnataka','Odisha','Puducherry','Delhi','Madhya Pradesh','TamilNadu','Telangana','Kerala','UttarPradesh','UttarKhand','Westbengal']
links = []
query = []
for state in states:
	for year in years:
			
		query.append('robbery in '+state+' in '+year)
